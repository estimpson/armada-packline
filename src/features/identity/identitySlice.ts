...
export const loginAsync = createAsyncThunk(
    'identity/login',
    async (loginInfo: { fxSPID: string; password: string }) => {
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(loginAsync.fulfilled, (state, action) => {
                state.status = 'idle';
                state.value.supplierCode = action.payload.supplierCode;
                state.value.printerDriver = action.payload.printerDriver;
                state.value.printerCopies = action.payload.printerCopies;
