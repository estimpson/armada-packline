...
export const getPartListAsync = createAsyncThunk(
    'part/getList',
    async (_dummy: void, { dispatch, getState }) => {
...
export const partSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getPartListAsync.pending, (state) => {
                state.status = 'loading';
            })
            .addCase(getPartListAsync.fulfilled, (state, action) => {
                state.status = 'idle';
